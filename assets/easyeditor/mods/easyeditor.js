    ...
    let easyeditor = {
        init: function (options) {
            var html = ['<div class="layui-unselect fly-edit ' + (options.style === "fangge" ? "easyeditor-fangge" : "") + '" >',
                ...
                '<span type="hr" title="分割线">hr</span>', '',
                    ...
                    video: function (editor) {
                        layer.open({
                            ...
                            content: ['<ul class="layui-form layui-form-pane" style="margin: 20px;">', '<li class="layui-form-item">',
                                ...
                                '<button type="button" class="layui-btn layui-btn-primary" onclick="layer.msg(\'抱歉,当前站点禁止上传视频！,您只可插入远程视频链接!\')" id="_uploadVideo"><i class="iconfont chengliangyun-md-icon-shangchuan"></i>上传视频</button>',
