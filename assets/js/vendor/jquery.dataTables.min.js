...
(function (h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "数据统计 _START_ to _END_ of _TOTAL_ 此页日志条数",
            sInfoEmpty: "数据统计 0 to 0 of 0 此页日志条数",
            sInfoFiltered: "(filtered from _MAX_ total 此页日志条数)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "每列展示 _MENU_ 此页日志条数",
            sLoadingRecords: "Loading...",
            sProcessing: "Processing...",
            sSearch: "搜索内容:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "没有搜索到匹配内容！"
        },
        oSearch: h.extend({},
            n.models.oSearch),
        sAjaxDataProp: "data",
