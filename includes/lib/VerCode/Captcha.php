...
class Captcha
{
    ...
    // 随机字符串
    public $random = 'qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM123456789';

    // 随机数大小
    public $font_size = 80;

    // 字体路径
    public $font_path = ROOT . 'assets/fonts/Nunito-SemiBold.woff';
    ...
    private function setRandomCode($im)
    {
        ...
        for ($i = 0; $i < $cou; $i++) {
            ...
            if (preg_match("/[\x7f-\xff]/", $this->random)) {
                ...
                $originalcode = 'qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM123456789'; //随机字符串
                $countdistrub = mb_strlen($originalcode);
                $dscode = $originalcode[rand(0, $countdistrub - 1)];
            }
            $color = imagecolorallocate($im, rand(10, 140), rand(10, 140), rand(10, 140));
