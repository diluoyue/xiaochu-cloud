...
require_once 'model/request/AlipayTradePrecreateRequest.php';
require_once 'model/request/AlipayTradeQueryRequest.php';
require_once 'model/request/AlipayTradeRefundRequest.php';
require_once 'model/result/AlipayF2FPrecreateResult.php';
require_once 'model/result/AlipayF2FQueryResult.php';
require_once 'model/result/AlipayF2FRefundResult.php';
require_once 'model/builder/AlipayTradeQueryContentBuilder.php';
...
class AlipayTradeService
{
    ...
    function writeLog($text)
    {
        ...
        //$text = characet ( $text );
        file_put_contents(SYSTEM_ROOT . "apay/log/log.txt", date("Y-m-d H:i:s") . "  " . $text . "\r\n", FILE_APPEND);
    }
