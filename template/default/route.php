...
switch ($_GET['p']) {
    ...
    case 'Article': //文章 /?mod=route&p=Article
        header("Location: " . ROOT_DIR . "#/pages/index/article");
        break;
    case 'Class': //分类 /?mod=route&p=Class
        header("Location: " . ROOT_DIR . "#/pages/class/index");
        break;
    case 'Order': //订单 /?mod=route&p=Order
        header("Location: " . ROOT_DIR . "#/pages/order/order");
        break;
    case 'Cart': //购物车 /?mod=route&p=Cart
        header("Location: " . ROOT_DIR . "#/pages/cart/cart");
        break;
    case 'User': //用户中心 /?mod=route&p=User
        header("Location: " . ROOT_DIR . "#/pages/user/user");
        break;
    case 'Comment': //商品评论  /?mod=route&p=Comment&gid=xxx
        header("Location: " . ROOT_DIR . "#/pages/shop/discuss?gid=" . $_GET['gid'] . "&count=9999");
        break;
    default:
